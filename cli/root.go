...
func Root() *cobra.Command {
	app := &App{cfg: weibo.DefaultConfig()}

	root := &cobra.Command{
		Use:   "weibo",
		Short: "Browse Weibo hot search topics (微博热搜)",
		Long: `weibo reads the Weibo hot search list through its public JSON endpoint.
No API key or account is required. It returns records as table, JSON, JSONL,
CSV, TSV, or URLs.
...
func (a *App) setup() error {
	...
	a.client = weibo.NewClient(a.cfg)
	return nil
}
